...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">客户管理系统 v.salt</a>
		</div>
		<!-- /.navbar-header -->
		...
		<ul class="nav navbar-top-links navbar-right">
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-messages">
					<li><a href="#">
							<div>
								<strong>骆靖琰</strong> <span class="pull-right text-muted">
									<em>昨天</em>
								</span>
							</div>
							<div>温新柳请我吃饭</div>
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-tasks">
					<li><a href="#">
							<div>
								<p>
									<strong>任务一</strong> <span class="pull-right text-muted">完成40%</span>
								</p>
					...
					<li><a href="#">
							<div>
								<p>
									<strong>任务二</strong> <span class="pull-right text-muted">完成20%</span>
								</p>
								<div class="progress progress-striped active">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li class="divider"></li>
					<li><a href="${pageContext.request.contextPath }/admin/exit.action"><i class="fa fa-sign-out fa-fw"></i>
							退出登录</a></li>
				</ul> <!-- /.dropdown-user --></li>
			<!-- /.dropdown -->
		</ul>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="insert.action"><i
							class="fa fa-dashboard fa-fw"></i> 新增客户</a></li>
				</ul>
			</div>
			<!-- /.sidebar-collapse -->
		</div>
